...
[![Status](https://img.shields.io/website?url=https%3A%2F%2Fblkprxy.vercel.app&label=API%20Status)](https://blkprxy.vercel.app/api/health)
...
**Example:**
```
https://blkprxy.vercel.app/api?url=https://api.example.com/users
```
